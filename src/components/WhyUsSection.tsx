...
const ADVANTAGES = [
  {
    ...
    desc: "Встречаемся лично — не очередная запись на YouTube. Реальный контакт, живые ответы прямо в зале.",
  },
  {
    icon: "Users",
    title: "До 30 человек и командная поддержка",
    desc: "В зале работают Сергей Черников и 2 ассистента. Каждый участник получает внимание и обратную связь.",
  },
  {
    icon: "MessageCircle",
    title: "Простое объяснение сложного без перегруза",
    desc: "Никаких формул и программирования. Сергей объясняет так, чтобы это можно было применить сегодня.",
  },
  {
    icon: "Zap",
  ...
  },
  {
    ...
    desc: "Программа обновляется каждый поток. Учим то, что работает прямо сейчас.",
  },
];
