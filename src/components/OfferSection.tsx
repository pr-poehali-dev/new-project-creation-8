...
const INCLUDES = [
  ...
  { icon: "BookOpen", text: "24 урока — 72 часа практики" },
  { icon: "Zap", text: "Практика с первого дня — на твоих задачах" },
  { icon: "Users", text: "До 30 участников · Сергей Черников + 2 ассистента" },
  { icon: "MessageCircle", text: "Поддержка и понятный путь внедрения" },
