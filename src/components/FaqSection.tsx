...
const FAQS = [
  ...
  },
  {
    ...
    a: "В потоке максимум 30 участников. В зале работают Сергей Черников и 2 ассистента — так каждый получает внимание и может задать вопрос лично. Это не лекция в аудитории на 200 человек.",
    icon: "Users",
  },
  {
    q: "Как записаться?",
