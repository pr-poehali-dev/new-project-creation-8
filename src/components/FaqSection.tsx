...
const FAQS = [
  ...
  },
  {
    ...
    a: "Именно для этого существует живая школа. В интернете полно видео и курсов, но они не учитывают твои задачи. Здесь мы разбираем применение на твоих реальных кейсах — в малой группе, с обратной связью тренера.",
    icon: "Lightbulb",
  },
  {
    q: "Это теория или практика?",
    a: "Практика — с первого занятия. Теоретической части минимум, только контекст. Уже на первом уроке ты работаешь с инструментами руками. Каждое занятие заканчивается конкретным результатом, который можно применить в работе.",
    icon: "Zap",
  },
  {
  ...
  },
  {
    ...
    a: "12 занятий за 3 месяца. Встречаемся раз в неделю. Плюс 20–30 минут между занятиями на короткие задания. Программа построена так, чтобы не выбивать из рабочего ритма, а встраиваться в него.",
    icon: "Clock",
  },
  {
    q: "Как записаться?",
    a: "Оставь заявку на сайте или напиши нам напрямую в Telegram. Мы расскажем о ближайшем потоке, ответим на вопросы и зафиксируем твоё место. Группы небольшие — лучше не откладывать.",
    icon: "MessageCircle",
  },
];
