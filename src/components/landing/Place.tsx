...
export default function Place() {
  ...
  return (
    <section ref={ref} id="place" className="section-dark py-16 sm:py-24 px-5 sm:px-6">
      <div className="bg-watermark hidden md:block">20</div>
      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        {/* LEFT */}
        <div className={inView ? "animate-fade-up" : "opacity-0"}>
          ...
          <h2 className="heading-display text-white text-3xl sm:text-4xl md:text-5xl mb-6 sm:mb-7">Место в городской памяти</h2>
          ...
          <p className="text-white/55 text-sm sm:text-base leading-relaxed mb-9">
        ...
        <div className={inView ? "animate-fade-right delay-200" : "opacity-0"}>
          <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
            <img src={CITY_IMG} alt="Площадь Адмирала Фокина" className="w-full h-72 sm:h-96 lg:h-[480px] object-cover" />
